...
HD_PWD='C:/Users/xoepe/Documents/USB-Test/usb_test/usb_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps2_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps2_interface.tcl
