...
HD_PWD='C:/Users/xoepe/Documents/USB-Test/usb_test/usb_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps2_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps2_interface.tcl -notrace
